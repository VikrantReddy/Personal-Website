  ...
  useEffect(() => {
    if (messages.length === 0) {
      const welcomeMessage: ChatMessage = {
        id: '0',
        sender: 'agent',
        text: `I am Gravity OS. This space is a living archive of work, thoughts, and technical logic. Tell me what you're looking for, or choose a prompt below to begin the exploration.`,
        timestamp: new Date(),
        contentType: 'text'
      };
